...
void mainMenu(int popularFood[FOOD]){
    ...
    cout << " \t\t ||WELCOME TO THE FAST FOOD RESTAURANT || " << endl ;
...
void menuUpdate(string nameFoodPrice[][COL], int num_food){
	...
	while (newFoodPrice < 1 || newFoodPrice > 1000){								
		
		cout << "The price of the food must be set in the range from rupees 1 to  1000 " << endl; 
		cout << "Please set the price of the food again:  ";					
...
void priceUpdate(string nameFoodPrice[][COL], int num_food){	
	...
	while (updatePrice < 1 || updatePrice > 1000){								
